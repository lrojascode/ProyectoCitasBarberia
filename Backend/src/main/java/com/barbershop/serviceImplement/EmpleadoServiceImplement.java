...
public class EmpleadoServiceImplement implements EmpleadoService {
	...
	public ResponseEntity<Map<String, Object>> actualizarEmpleados(Empleado emp, Long id) {
	    ...
	    if (empleadoOpt.isPresent()) {
	        ...
	        if (emp.getFirstName() != null) empleado.setFirstName(emp.getFirstName());
	        if (emp.getLastName() != null) empleado.setLastName(emp.getLastName());
	...
	public ResponseEntity<Map<String, Object>> listarServiciosPorEmpleado(Long idEmpleado) {
	    ...
	    if (employee == null) {
	        ...
	        errorResponse.put("mensaje", "El empleado " + idEmpleado + " no fue encontrado.");
	    ...
	    List<Map<String, Object>> services = employeeServices.stream().map(es -> {
	        Servicio service = es.getServicio();  

	        // Crear el mapa sin el ID del servicio
	...
	public ResponseEntity<Map<String, Object>> listarEmpleadosPorServicio(Long idServicio) {
	    ...
	    Servicio servicio = serviceDao.findById(idServicio)
	            .orElse(null); 
